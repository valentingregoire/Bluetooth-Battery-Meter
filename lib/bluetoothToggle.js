...
import {UpowerIndicator} from './upowerIndicator.js';
        ...
        this._settings.connectObject(
            ...
            'changed::enable-upower-level-icon', () => {
                ...
                if (this._upowerEnabled) {
                    this._upowerIndicator = new UpowerIndicator(this._settings, this._widgetInfo);
                } else {
                    this._upowerIndicator?.destroy();
                    this._upowerIndicator = null;
                }
            },
            this
        );
            ...
            for (const dev of devices) {
                ...
                if (this._deviceList.has(path)) {
                    ...
                    if (props.indicatorMode > 0) {
                        const indicator = new BluetoothIndicator(this._settings, dev, props.indicatorMode, props.icon, this._widgetInfo, false);
