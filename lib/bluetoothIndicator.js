...
export const BluetoothIndicator = GObject.registerClass({
    ...
    constructor(settings, device, indicatorMode, iconType, widgetInfo, isUpowerDevice) {
        super();
        ...
        this._percentageProps = isUpowerDevice ? 'percentage' : 'battery_percentage';
    ...
    _addLevelWidget(iconSize) {
        ...
        this._device.bind_property(this._percentageProps,
        ...
        if (this._indicatorMode === 1) {
            ...
            this._device.bind_property_full(this._percentageProps,
        ...
        this.connectObject('notify::batteryPercentage', () => {
            this._levelWidget?.updateValues(this._device[this._percentageProps]);
        },
        this);
        ...
        this._settings.connectObject('changed::enable-battery-indicator-text', () => {
            this._percentageLabelVisible = this._settings.get_boolean('enable-battery-indicator-text');
            this._percentageLabel.visible = this._percentageLabelVisible && this._device[this._percentageProps] > 0;
        }, this);
